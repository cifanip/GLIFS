...
!========================================================================================!
  subroutine init_solver()
    ...
    if (w%is_stored(run_time%output_dir,fields_dir)) then
      ...
      call compute_ic(lap_db%laplacian,w)
...
!========================================================================================!
  subroutine write_out()
    ...
    call lap_db%laplacian%apply_inv(psi)
    call psi%write_to_disk(run_time%output_dir,fields_dir)
        
    !write sph coefficients of vorticity
    call compute_sph_coeff(lap_db%laplacian,w,run_time%output_dir,fields_dir)
        
    !write sph coefficients of stream function
    call compute_sph_coeff(lap_db%laplacian,psi,run_time%output_dir,fields_dir)
