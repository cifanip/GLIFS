module mpi_control_mod
  ...
  type, public :: mpi_control
    ...
    procedure, public :: delete => delete_mpi_control
    procedure, public :: ctor   => mpi_control_CTOR

  end type
  
  private :: delete_mpi_control,&
             mpi_control_CTOR
...
!========================================================================================!
  subroutine delete_mpi_control(this) 
...
!========================================================================================!
  subroutine mpi_control_CTOR(this) 
